            ...
            <div
                ...
                
               {
                cartData?.products.map((product)=>{
                  return <Cartproduct  product={product} removeCartProduct={removeCartProduct} setcart={setCartData} setNumOfCartItems={setNumOfCartItems}/>
                })
               }
                ...
                <div className="mt-8">
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-between py-8">
                            ...
                            <p className="font-semibold text-xl leading-8 text-indigo-600">${cartData?.totalCartPrice}</p>
                        </div>
                        <button
